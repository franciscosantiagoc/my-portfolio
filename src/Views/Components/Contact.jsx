      ...
      <section name="contact" className={style.container}>
        ...
        <div className={style.contentoptions}>
          <div className={style.opcontac}>
            <a className={style.linkop} href="mailto:fcosantiagoc@gmail.com" target="_blank">
              <p>Email</p>
              <FontAwesomeIcon icon={faEnvelope} />
            </a>
          </div>         
          <div className={style.opcontac}>
            <a className={style.linkop} href="https://www.linkedin.com/in/franciscosantiagoc" target="_blank" >
              <p>LinkedIn</p>
